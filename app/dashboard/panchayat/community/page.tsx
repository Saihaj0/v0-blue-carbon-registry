...
export default function PanchayatCommunityPage() {
  const navigationItems = [
    ...
    { href: "/dashboard/panchayat/community", label: "Community", icon: Users, active: true },
  ...
  const communityMembers = [
    {
      ...
      projects: ["Village Mangrove Restoration"],
      joinDate: "2023-06-15",
      totalEarnings: 25000,
      photosUploaded: 145,
      status: "active",
    ...
    },
    {
      ...
      name: "Sunita Devi",
      role: "Field Worker",
      village: "Coastal Ward 3",
      phone: "+91 87654 32109",
      email: "sunita.devi@email.com",
      projects: ["Backwater Seagrass Initiative"],
      joinDate: "2023-09-01",
      totalEarnings: 18000,
      photosUploaded: 89,
      status: "active",
    ...
    },
    {
      ...
      name: "Mohan Singh",
      role: "Data Collector",
      village: "Mangrove Settlement",
      phone: "+91 76543 21098",
      email: "mohan.singh@email.com",
      projects: ["Village Mangrove Restoration", "Backwater Seagrass Initiative"],
      joinDate: "2023-01-15",
      totalEarnings: 32000,
      photosUploaded: 203,
      status: "active",
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Manage and support your local community participants</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Photos This Month</p>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex flex-col space-y-1">
                        ...
                        <Badge className={getPerformanceColor(member.performance)} variant="outline">
                          {member.performance}
                        </Badge>
                      </div>
                    </div>
